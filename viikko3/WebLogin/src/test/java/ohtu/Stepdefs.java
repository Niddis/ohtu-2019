...
public class Stepdefs {
    ...
    public void validUsernameAnTooShortPasswordAndMatchingPasswordConfirmationAreGiven(String username, String password) {
        createNewUser(username, password, password);
    }
    ...
    private void logOutAfterCreatingAnUser() {
